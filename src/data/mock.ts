...
// Fotos de campo (antes/depois) — peixe e frutos do mar crus
const PHOTO_RAW_SHRIMP  = 'https://upload.wikimedia.org/wikipedia/commons/7/71/Spot_prawns.jpg'
const PHOTO_TILAPIA_RAW = 'https://upload.wikimedia.org/wikipedia/commons/4/48/Tilapia_fish.jpg'
const PHOTO_FISH_MARKET = 'https://upload.wikimedia.org/wikipedia/commons/e/eb/Tsukiji_Fish_market.JPG'
const PHOTO_FRESH_FISH  = 'https://upload.wikimedia.org/wikipedia/commons/2/21/West_of_Aberdeen_Wholesale_Fish_Market.JPG'
...
export const mockPhotos: MockPhoto[] = [
  // Hoje — Maria Silva
  { id: 'mp-101', storeId: '1', promotorId: '1', type: 'before', timestamp: '07:32', date: today, imageUrl: PHOTO_FISH_MARKET,  lat: -19.9334, lng: -43.9383 },
  { id: 'mp-102', storeId: '1', promotorId: '1', type: 'after',  timestamp: '08:18', date: today, imageUrl: PHOTO_RAW_SHRIMP,   lat: -19.9334, lng: -43.9383 },
  { id: 'mp-103', storeId: '2', promotorId: '1', type: 'before', timestamp: '08:41', date: today, imageUrl: PHOTO_TILAPIA_RAW,  lat: -19.9248, lng: -43.9701 },
  { id: 'mp-104', storeId: '2', promotorId: '1', type: 'after',  timestamp: '09:30', date: today, imageUrl: PHOTO_FRESH_FISH,   lat: -19.9248, lng: -43.9701 },
  // Hoje — João Santos
  { id: 'mp-201', storeId: '1', promotorId: '2', type: 'before', timestamp: '08:00', date: today, imageUrl: PHOTO_RAW_SHRIMP,   lat: -19.9334, lng: -43.9383 },
  { id: 'mp-202', storeId: '1', promotorId: '2', type: 'after',  timestamp: '08:52', date: today, imageUrl: PHOTO_TILAPIA_RAW,  lat: -19.9334, lng: -43.9383 },
  { id: 'mp-203', storeId: '2', promotorId: '2', type: 'before', timestamp: '09:10', date: today, imageUrl: PHOTO_FISH_MARKET },
  { id: 'mp-204', storeId: '2', promotorId: '2', type: 'after',  timestamp: '09:58', date: today, imageUrl: PHOTO_FRESH_FISH },
  // Hoje — Ana Costa
  { id: 'mp-301', storeId: '3', promotorId: '3', type: 'before', timestamp: '07:47', date: today, imageUrl: PHOTO_FRESH_FISH },
  { id: 'mp-302', storeId: '3', promotorId: '3', type: 'after',  timestamp: '08:40', date: today, imageUrl: PHOTO_RAW_SHRIMP },
  { id: 'mp-303', storeId: '6', promotorId: '3', type: 'before', timestamp: '09:00', date: today, imageUrl: PHOTO_TILAPIA_RAW },
  { id: 'mp-304', storeId: '6', promotorId: '3', type: 'after',  timestamp: '09:50', date: today, imageUrl: PHOTO_FISH_MARKET },
  // Hoje — Pedro Oliveira
  { id: 'mp-401', storeId: '5', promotorId: '4', type: 'before', timestamp: '08:31', date: today, imageUrl: PHOTO_RAW_SHRIMP,  lat: -19.9547, lng: -43.9512 },
  { id: 'mp-402', storeId: '5', promotorId: '4', type: 'after',  timestamp: '09:25', date: today, imageUrl: PHOTO_FRESH_FISH,  lat: -19.9547, lng: -43.9512 },
  // Hoje — Carla Mendes
  { id: 'mp-501', storeId: '6', promotorId: '5', type: 'before', timestamp: '07:03', date: today, imageUrl: PHOTO_TILAPIA_RAW },
  { id: 'mp-502', storeId: '6', promotorId: '5', type: 'after',  timestamp: '07:55', date: today, imageUrl: PHOTO_FISH_MARKET },
  { id: 'mp-503', storeId: '3', promotorId: '5', type: 'before', timestamp: '08:20', date: today, imageUrl: PHOTO_RAW_SHRIMP },
  { id: 'mp-504', storeId: '3', promotorId: '5', type: 'after',  timestamp: '09:10', date: today, imageUrl: PHOTO_FRESH_FISH },
  // Ontem — Maria Silva
  { id: 'mp-y101', storeId: '3', promotorId: '1', type: 'before', timestamp: '08:10', date: yesterday, imageUrl: PHOTO_TILAPIA_RAW, lat: -19.8938, lng: -43.9445 },
  { id: 'mp-y102', storeId: '3', promotorId: '1', type: 'after',  timestamp: '09:05', date: yesterday, imageUrl: PHOTO_FISH_MARKET },
  { id: 'mp-y103', storeId: '5', promotorId: '1', type: 'before', timestamp: '11:00', date: yesterday, imageUrl: PHOTO_RAW_SHRIMP,  lat: -19.9547, lng: -43.9512 },
  { id: 'mp-y104', storeId: '5', promotorId: '1', type: 'after',  timestamp: '11:50', date: yesterday, imageUrl: PHOTO_FRESH_FISH },
  // Ontem — João Santos
  { id: 'mp-y201', storeId: '1', promotorId: '2', type: 'before', timestamp: '08:05', date: yesterday, imageUrl: PHOTO_TILAPIA_RAW, lat: -19.9334, lng: -43.9383 },
  { id: 'mp-y202', storeId: '1', promotorId: '2', type: 'after',  timestamp: '08:58', date: yesterday, imageUrl: PHOTO_FISH_MARKET },
  // Ontem — Carla Mendes
  { id: 'mp-y501', storeId: '3', promotorId: '5', type: 'before', timestamp: '07:15', date: yesterday, imageUrl: PHOTO_RAW_SHRIMP },
  { id: 'mp-y502', storeId: '3', promotorId: '5', type: 'after',  timestamp: '08:05', date: yesterday, imageUrl: PHOTO_TILAPIA_RAW },
]
